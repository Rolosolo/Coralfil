# Coralfill™ Research & Development Roadmap
...
**Key Innovation**: Calcium carbonate-based 3D-printed substrates with controlled-release nutrient systems that accelerate coral settlement and growth by an estimated **18-35%** compared to traditional methods.
...
- Settlement rate increase: **22-38%** vs. concrete (Ref: Chamberland et al., 2017)
- Growth rate increase: **18-35%** vs. traditional substrates (Ref: Boström-Einarsson et al., 2020)
- Survival rate: **85-92%** at 16 weeks (Ref: Suggett & van Oppen, 2022)
...
- Recruitment density: **2.5-4.2x** higher than controls (Ref: Hein et al., 2020)
